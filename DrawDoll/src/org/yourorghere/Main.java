...
public class Main implements GLEventListener, MouseListener, MouseMotionListener, KeyListener{
    ...
    public static void main(String[] args){
        ...
        Frame frame = new Frame("Draw Doll : Doll (Press J to jump and press W to walk)");
    ...
    public void init(GLAutoDrawable drawable){
        ...
        //Siapkan area gambar dan mode bayangan
    ...
    public void display(GLAutoDrawable drawable){
        ...
        // Setel ulang matriks saat ini ke "identitas"
        gl.glLoadIdentity();
        ...
        // Pindahkan seluruh adegan
        gl.glTranslatef(X_POSITION, Y_POSITION, Z_POSITION);
        gl.glRotatef(view_rotx,1.0f,0.0f,0.0f);
        gl.glRotatef(view_roty,0.0f,1.0f,0.0f);
        gl.glRotatef(90,0.0f,0.0f,1.0f);

        // draw DOll in the window
        DrawDoll doll = new DrawDoll();
        doll.draw_doll(gl, keys['W'], keys['J']);
